...
NormEventCounts <- function(x, 
  ...
  if(unit.analysis == "country.day"){ # see here for code annotations
    ...
    dl.daily.country.data <- download.file(url="https://data.gdeltproject.org/normfiles/daily_country.csv", 
                                        destfile=dest, 
                                        quiet=FALSE)
  ...
  if(unit.analysis == "country.month"){
    ...
    dl.monthly.country.data <- download.file(url="https://data.gdeltproject.org/normfiles/monthly_country.csv", 
                                        destfile=dest, 
                                        quiet=FALSE)
  ...
  if(unit.analysis == "country.year"){ 
    ...
    dl.yearly.country.data <- download.file(url="https://data.gdeltproject.org/normfiles/yearly_country.csv", 
                                        destfile=dest, 
                                        quiet=FALSE)
  ...
  if(unit.analysis == "day"){
    ...
    dl.daily.data <- download.file(url="https://data.gdeltproject.org/normfiles/daily.csv", 
                                        destfile=dest, 
                                        quiet=FALSE)
  ...
  if(unit.analysis == "month"){
    ...
    dl.monthly.data <- download.file(url="https://data.gdeltproject.org/normfiles/monthly.csv", 
                                        destfile=dest, 
                                        quiet=FALSE)
  ...
  if(unit.analysis == "year"){
    ...
    dl.yearly.data <- download.file(url="https://data.gdeltproject.org/normfiles/yearly.csv", 
                                        destfile=dest, 
                                        quiet=FALSE)
